...
import "github.com/yaredow/glimpse-api/internal/validator"
...
func ValidateInteractionInput(v *validator.Validator, movieID int64, action, gridSessionID string, gridPosition *int) {
