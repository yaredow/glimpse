...
func ScoreMovies(candidates []*entity.Movie, affinities []entity.UserAffinity, recentlyShown map[int64]time.Time, totalInteractions int) []ScoredMovie {
...
func movieScore(m *entity.Movie, affinities map[string]float64, recentlyShown map[int64]time.Time, explorationRate float64) float64 {
...
func buildAffinityMap(affinities []entity.UserAffinity) map[string]float64 {
