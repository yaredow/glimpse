...
SELECT
    id, tmdb_id, imdb_id, vague_description, genres, title, original_title, full_synopsis, poster_path, backdrop_path, release_date, runtime, vote_average, vote_count, original_language, popularity, created_at, shown_count, watched_count, global_watch_rate, tagline, director, cast_members, trailer_key, spoken_languages, production_countries, detail_synced_at
FROM
    movies
WHERE
...
RETURNING id, tmdb_id, imdb_id, vague_description, genres, title, original_title, full_synopsis, poster_path, backdrop_path, release_date, runtime, vote_average, vote_count, original_language, popularity, created_at, shown_count, watched_count, global_watch_rate, tagline, director, cast_members, trailer_key, spoken_languages, production_countries, detail_synced_at
`
